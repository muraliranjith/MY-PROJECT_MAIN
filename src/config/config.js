...
const envVarsSchema = Joi.object()
  .keys({
    ...
    OCR_URL: Joi.string().description('External API url for ocr'),
    POSTGRES_URL: Joi.string().required().description('Mongo DB url'),
    POSTGRES_URL_TEST: Joi.string().required().description('Mongo DB test url'),
